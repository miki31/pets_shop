...
INSERT INTO advertisement (id, title, category_id, description, photo, price, posted_on) VALUES
(1, 'Якась цікава назва посту', 1, 'Віддам в добрі руки 2-x кошенят, 2 місяці, хлопчик і дівчинка. Окрас чорно-білий, дуже-дуже лагідні. Привчені до лотка', null, null, '1999-1-1'),
(2, 'Супер цікава назва посту', 3, 'продам папугу, сидить в клітці і радіє життю', null, 500, '2012-3-3'),
(3, "Обов'язково купіть!!!", 6, 'Продається черепаха, червоновуха. Вік 3 місяці, кличка Флеш', null, 400, '2019-09-25'),
(4, 'Миле цуценя :))', 2, 'Продам цуцика порода Бернський Зенненхунд, хлопчик вік 2,5 місяці. Всі щеплення проведені, Документи КСУ, паспорт', null, 10000, '2019-06-16'),
(5, 'Інше миле цуценя :))', 2, null, null, 10099.99, '2019-06-16'),
(6, null, 1, 'Продається черепаха, червоновуха. Вік 3 місяці, кличка Флеш', null, 255.99, '2019-09-01');
