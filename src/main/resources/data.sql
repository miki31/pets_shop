...
(1, 3, 'Якась цікава назва посту', 1, 'Віддам в добрі руки 2-x кошенят, 2 місяці, хлопчик і дівчинка. Окрас чорно-білий, дуже-дуже лагідні. Привчені до лотка', null, null, '1999-1-1'),
...
(5, 6, 'Інше миле цуценя :))', 2, null, null, 10099.99, '2019-06-16'),
(6, 10, null, 1, 'Продається черепаха, червоновуха. Вік 3 місяці, кличка Флеш', null, 255.99, '2019-09-01');
